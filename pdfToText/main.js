  ...
  const processImage = async (imageUrl) => {
    ...
    $.ajax({
      ...
      headers: {
        ...
        Authorization:
          'Bearer ya29.a0Ael9sCN_Ifx2yzeFLaq5vZoB_2lEMeR2lkhbHPJ-QsTGS4FgNrA_zplF5sEkrcq7WgC2Z_W-kPqD-ee4aWVBfJWx2EtiMXU21hOVRx30wmPColsVO9CbaY23aUwaKGvRNvK2Il5r9lmc_bMIkiacWtpMIv6N3vwpRToKVgaCgYKAbISARESFQF4udJho76BxqS0KOFWGHPPom_Z1Q0173',
    ...
    fullTextAnnotation.pages.forEach((page) => {
      page.blocks.forEach((block) => {
        ...
        blockDiv.style.width =
          blockBoundingBox[2].x - blockBoundingBox[0].x + 'px';
        blockDiv.style.height =
          blockBoundingBox[2].y - blockBoundingBox[0].y + 'px';
        ...
        block.paragraphs.forEach((paragraph) => {
          ...
          paragraphDiv.style.width =
            paragraphBoundingBox[2].x - paragraphBoundingBox[0].x + 'px';
          paragraphDiv.style.height =
            paragraphBoundingBox[2].y - paragraphBoundingBox[0].y + 'px';
          ...
          paragraph.words.forEach((word) => {
            ...
            wordDiv.style.width =
              wordBoundingBox[2].x - wordBoundingBox[0].x + 'px';
            wordDiv.style.height =
              wordBoundingBox[2].y - wordBoundingBox[0].y + 'px';
  ...
  const getSummary = (text) => {
    ...
    $.ajax({
      ...
      headers: {
        'Content-Type': 'application/json',
        Authorization:
          'Bearer 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',
      },
      data: JSON.stringify({
